...
class SystemModel:
    ...
    def __init__(self, f, Q, h, R, T, T_test, m, n,use_velocity = False ,is_m1x_0_true= False,m1x_0_train = None,is_m1x_0_validation_true= False,m1x_0_validation = None, is_m1x_0_test_true= False,m1x_0_test = None,noises_train=None, noises_cv= None,to_use_noises= False, prior_Q=None, prior_Sigma=None, prior_S=None):
        ...
        self.is_m1x_0_true = is_m1x_0_true
        self.m1x_0_train = m1x_0_train
        self.is_m1x_0_validation_true = is_m1x_0_validation_true
        self.m1x_0_validation = m1x_0_validation
        self.is_m1x_0_test_true = is_m1x_0_test_true
        self.m1x_0_test = m1x_0_test
        self.noises_train = noises_train
        self.noises_cv = noises_cv
        self.to_use_noises = to_use_noises
    ...
    def GenerateBatch(self, args, size, T, randomInit=False):
        if(randomInit):
            ...
            initConditions = self.m1x_0.view(1,self.m,1).expand(size,-1,-1) # Linoy: shape of (size = train size, m, 1). The tensor is initialized with the column vector m1x_0 replicated along the first dimension
