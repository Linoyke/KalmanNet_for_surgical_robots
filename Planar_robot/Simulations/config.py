...
def general_settings():
    ...
    parser.add_argument('--lr_change_flag', type=bool, default=False, metavar='is_lr_scheduler_required',
                        help='True\False if the user wants to change lr after N epochs (default: false)')
    parser.add_argument('--epoch_thresh_for_lr', type=int, default=600, metavar='number_of_epochs',
                        help='number of epochs desired that after it the lr is changed default: 600')
    ...
    ### if solving for robot case
    parser.add_argument('--is_robot_case', type=bool, default=False, metavar='_',
                        help='does constraint required')
